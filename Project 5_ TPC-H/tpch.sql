...
----- Copy the tbl file to postgresql
...
(
  d_date_dim_id              SERIAL PRIMARY KEY,
...
(d_date_actual,d_epoch,d_day_suffix,d_day_name,d_day_of_week,d_day_of_month,d_day_of_quarter,
d_day_of_year,d_week_of_month,d_week_of_year,d_week_of_year_iso,d_month_actual,
d_month_name,d_month_name_abbreviated,d_quarter_actual,d_quarter_name,
d_year_actual,d_first_day_of_week,d_last_day_of_week,d_first_day_of_month,
d_last_day_of_month,d_first_day_of_quarter,d_last_day_of_quarter,d_first_day_of_year,
d_last_day_of_year,d_mmyyyy,d_mmddyyyy,d_weekend_indr)
SELECT 
...
SELECT l.l_orderkey, l.l_linenumber, c.c_custkey, l.l_partkey, l.l_suppkey, od.d_date_dim_id, o.o_orderpriority, o.o_shippriority, l.l_quantity, l.l_extendedprice, 
       o.o_totalprice, l.l_discount, (l.l_extendedprice * (1 - l.l_discount)), ps.ps_supplycost, l.l_tax, sd.d_date_dim_id, cd.d_date_dim_id,  rd.d_date_dim_id, l.l_shipmode
FROM LINEITEM l, ORDERS o, CUSTOMER c, PART p, SUPPLIER s, PARTSUPP ps, DIM_DATE od, DIM_DATE sd, DIM_DATE cd, DIM_DATE rd
WHERE o.o_orderkey = l.l_orderkey and o.o_custkey = c.c_custkey and l.l_partkey = p.p_partkey and l.l_suppkey = s.s_suppkey 
	  and l.l_partkey = ps.ps_partkey and l.l_suppkey = ps.ps_suppkey and od.d_date_actual = o.o_orderdate and sd.d_date_actual = l.l_shipdate
      and cd.d_date_actual = l.l_commitdate and rd.d_date_actual = l.l_receiptdate;
